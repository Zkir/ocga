...
(cd /home/zkir/osm2world  ; sh osm2world.sh -i /home/zkir/src/ocga/ocga_output/$MODEL_NAME-rewrite.osm -o /home/zkir/src/ocga/ocga_output/$MODEL_NAME.gltf )


# ===========  Step 2.  =================================================================================================
# activate 3d viewer. On Win10, it is built in.
f3d ocga_output/$MODEL_NAME.gltf
