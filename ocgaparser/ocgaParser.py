...
class ocgaParser ( Parser ):
    ...
    ruleNames =  [ "prog", "ocga_header", "rule", "rule_header", "operator", 
                   ...
                   "string_const", "argument", "key_name", "tag_value" ]
    ...
    class Key_nameContext(ParserRuleContext):
        ...
        def RULE_NAME(self, i:int=None):
            if i is None:
                return self.getTokens(ocgaParser.RULE_NAME)
            else:
                return self.getToken(ocgaParser.RULE_NAME, i)
    ...
    def key_name(self):
        ...
        self.enterRule(localctx, 20, self.RULE_key_name)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 139
    ...
    def tag_value(self):
        ...
        self.enterRule(localctx, 22, self.RULE_tag_value)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 147
